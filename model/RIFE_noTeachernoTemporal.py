...
from model.LSTM_attention_NoTeacherNoTemporal import *
...
class Model:
    def __init__(self, pretrainedModel, local_rank=-1, arbitrary=False):
        ...
        self.sobel = SOBEL()
        if local_rank != -1:
            self.flownet = DDP(self.flownet, device_ids=[local_rank],find_unused_parameters=True, output_device=local_rank)
