...
import random
import argparse
from model.RIFE_noTeachernoTemporal import Model
...
if __name__ == "__main__":    
    ...
    checkpoint = convert_load(torch.load(f'{pretrained_path}/flownet.pkl',map_location='cuda:{}'.format(args.local_rank)))
